...
#include "DisplayHelper.h"
	...
	void runProd()
	{
		...
		std::vector<PartLocationList> decompseResult;

		shared_ptr<vector<shared_ptr<CImgDisplay>>> displayVector2 = DisplayHelper::showDecomposeResult(world, decompseResult, 1);
